...
class Oil(Point):
    weights = pylab.array([1.0] * 5)  ## This is a class variable, not instance variable
...
#US Counties example
def readOilData(fName, numEntries = 74):
...
testShowHistory(k = 5, cutoff = 0.0001, numTrials = 10, printSteps = False, printHistory = False)
